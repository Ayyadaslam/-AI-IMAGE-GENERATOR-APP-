...
// const OPENAI_API_KEY = "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"
...
//         const {data} =await response.json()/// get data from response here 
//         console.log(data)
...
//     /// get user input and quality form
...
//     // create html markup for image card with loading stat


//     const imgCardMarkup = Array.from({length: userImageQuality} , ()=>
    
//     `<div class="img-card" data-src="image.jpg">
...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
